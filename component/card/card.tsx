  ...
  return (
    <>
      ...
      <section
        ...
        className="p-2.5 h-fit min-h-[100px] items-center flex text-left rounded-xl hover:ring-2 hover:ring-inset hover:ring-black cursor-grab relative task"
        onMouseEnter={() => {
          setMouseIsOver(true);
        }}
        onMouseLeave={() => {
      ...
      >
        <section className="flex flex-col items-start gap-3 max-w-[250px] p-2">
          <p className=" w-full overflow-y-auto overflow-x-hidden text-lg font-semibold break-words">
            {" "}
            {task.name}{" "}
          </p>
          <p className=" w-full overflow-y-auto overflow-x-hidden text-base">
            {task.content}
          </p>
          <p className=" w-full overflow-y-auto overflow-x-hidden text-sm">
            {" "}
            {getDayMonthYearTime(task.date)}{" "}
          </p>
        </section>
        ...
        <section className="">
          ...
          <button>
            <Edit2
              ...
              size={32}
              className="absolute right-4 top-[70%] -translate-y-1/2 p-2 rounded opacity-60 hover:opacity-100"
              color="#000000"
            />
          </button>
        </section>
